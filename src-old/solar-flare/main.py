...
column_names = [
    ...
    "activity",
    "evolution",
    "past24hour_flare_activity",
    "historically_complex",
    "region_became_historically_complex_on_pass",
    "area",
    "largest_spot_area",
    "common_flare",
    "moderate_flare",
...
flare_1 = pd.read_csv("flare1.csv", sep=" ", names=column_names).apply(
    LabelEncoder().fit_transform
)
flare_2 = pd.read_csv("flare2.csv", sep=" ", names=column_names).apply(
    LabelEncoder().fit_transform
)
